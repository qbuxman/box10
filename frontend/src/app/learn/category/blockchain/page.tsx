...
import {CheckSquare, Gift, GraduationCap, Loader} from "lucide-react"
import { Lesson } from "@/types/Lesson"
import { Button } from "@/components/ui/button"
import { useAccount } from "wagmi"
import { claimToken } from "@/utils/claimToken"
import {Diplomata} from "next/dist/compiled/@next/font/dist/google";
...
const LearnBlockchainCategory = () => {
    ...
    useEffect(() => {
        const getLesson = async () => {
            setIsLoading(true)
            try {
                const response = await fetch("/api/learn/categories/blockchain/lesson")
