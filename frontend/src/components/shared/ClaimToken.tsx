...
export function ClaimToken() {
    ...
    const sendToken = async () => {
        ...
        await claimToken(recipientForBoxToken as `0x${string}`, amountToSend, activityId)
            .then((response) => {
                if (response.success) {
                    toast.success(`${amountToSend} BOX10 ont été envoyés à l'adresse ${recipientForBoxToken} !`)
                }
