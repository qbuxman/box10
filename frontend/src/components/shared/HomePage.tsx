        ...
        <div className="max-w-6xl mx-auto p-6 space-y-8">
            ...
            <div className="text-center space-y-2">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style={{ backgroundColor: '#234C6A' }}>
                    <span className="text-white text-2xl"><Package/></span>
                </div>
            ...
            <Card className="border-2" style={{ borderColor: '#E3E3E3' }}>
                <CardHeader>
                    <CardTitle className="text-2xl flex items-center gap-2" style={{ color: '#234C6A' }}>
                        <span>🎯</span> Objectif
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    <p className="text-lg" style={{ color: '#456882' }}>
                        Proposer des stratégies accessibles, diversifiées et capables d’atteindre 10 % ou plus selon votre profil.
                    </p>
                </CardContent>
            </Card>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <CardContent>
                            <p className="text-sm" style={{ color: '#456882' }}>
                                Grâce à <strong>Transak</strong>, vous achetez des USDC en 2 minutes, puis vous les investissez dans nos stratégies.
                            </p>
                        </CardContent>
                    </Card>
                </div>
