  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <Card className="border-2 border-[#E3E3E3]">
        <CardHeader>
          <CardTitle className="text-2xl flex items-center gap-2 text-[#234C6A]">
            <span>🎯</span> Objectif
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="hover:scale-[1.02] transition-transform duration-200 cursor-pointer border-2 border-[#E3E3E3] h-full">
            <CardHeader>
