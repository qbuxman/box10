    ...
    <div>
      ...
      <Card className={"mb-6"}>
        <CardHeader>
          <CardTitle className={"align-middle"}>
            🎯 Objectif : proposer des stratégies accessibles, diversifiées et
            capables d’atteindre 10 % ou plus selon votre profil.
          </CardTitle>
        </CardHeader>
      </Card>
      <p className={"mb-2"}>
      ...
      <div className="flex items-center justify-center mt-8 gap-4">
        <Link href="/strategies">
          ...
          >
            <ChartAreaIcon /> Voir les stratégies
          </Button>
        </Link>
        <Link href="/learn">
          <Button
          ...
          <div>
            <Link href="/distribute">
              <Button
                ...
                className="!px-8 !py-6 cursor-pointer"
              >
                <BadgeDollarSign /> Envoyer des jetons
              </Button>
            </Link>
          </div>
        ) : (
