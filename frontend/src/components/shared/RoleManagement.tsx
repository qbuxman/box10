...
const RoleManagement = () => {
    ...
    const addRoleToAddress = async () => {
        ...
        try {
            ...
            const hasRole = await checkDistributorRole(addressToAddRole as `0x${string}`)
            ...
            if (data.success) {
                toast.success(`Rôle de distributeur ajouté avec succès pour l'adresse ${addressToAddRole}`)
